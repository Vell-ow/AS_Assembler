...
public class Parser
{
  ...
  */
  ...
  private void parseCommandType()
  {
    ...
    {
      System.out.println("Not sure why, but a NullPointerException is being thrown in Parser and Main. A StringOutOfBoundsException is also being thrown in both Parser and Main, but we're safely exiting the program now while we try to figure out what's causing these issues.");
      System.exit(0);
    }
  }  
